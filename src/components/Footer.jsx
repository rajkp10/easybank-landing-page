...
const LinksContainer = ({ links }) => {
  return (
    <ul className="flex flex-col items-center justify-between gap-2 md:items-start">
      {links.map((link) => (
        <li key={link}>
          <a
            href="#"
            className="text-sm duration-150 ease-linear text-neutral-2 hover:text-primary-2"
          >
            {link}
          </a>
        </li>
...
function Footer() {
  return (
    <footer className="flex items-center justify-center w-full px-4 py-8 bg-primary-1">
      <div className="flex flex-col w-full max-w-6xl gap-4 md:gap-0 md:flex-row md:justify-between">
        <section className="flex flex-col gap-4 md:gap-36 md:flex-row md:justify-between">
            ...
            <div className="flex gap-4">
              ...
              <a href="#">
                <svg
                  ...
                  className="duration-150 ease-in fill-white hover:fill-primary-2 hover:cursor-pointer"
                  width="20"
                  height="20"
                >
          ...
          <LinksContainer links={Links1} />
          <LinksContainer links={Links2} />
        </section>
        <section className="flex flex-col items-center justify-between gap-4 md:items-end">
          <div>
            <button className="px-8 py-3 text-sm text-white duration-150 ease-in rounded-3xl bg-gradient-to-r from-primary-2 to-primary-3 hover:brightness-125">
              Request Invite
            </button>
          </div>
